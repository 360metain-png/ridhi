...
export const SPEND_CATEGORIES: SpendCategory[] = [
  ...
  { id: "sc5", label: "Audio Call",       icon: "phone",        color: "#3B82F6", desc: "Call any host live — requires paid coins",         cost: "10 paid coins/min",        route: "/random-call" },
  { id: "sc6", label: "Video Call",       icon: "video",        color: "#10B981", desc: "Face-to-face with hosts — requires paid coins",    cost: "25 paid coins/min",        route: "/random-call" },
