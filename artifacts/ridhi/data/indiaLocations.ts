...
export const INDIA_LOCATIONS: StateData[] = [
  ...
  },
  {
    ...
    districts: [
      ...
      "Kondagaon", "Korba", "Koriya", "Mahasamund", "Manendragarh", "Mohla-Manpur-Ambagarh Chowki",
  ...
  },
  {
    ...
    districts: [
      ...
      "Mahendragarh", "Mewat (Nuh)", "Palwal", "Panchkula", "Panipat", "Rewari",
  ...
  },
  {
    ...
    districts: [
      ...
      "Morena", "Narsimhapur", "Neemuch", "Niwari", "Panna",
  ...
  },
  {
    ...
    districts: [
      ...
      "Dholpur", "Didwana-Kuchaman", "Dudu", "Dungarpur", "Gangapur City",
      "Hanumangarh", "Jaipur", "Jaipur Rural", "Jaisalmer", "Jalore",
      "Jhalawar", "Jhunjhunu", "Jodhpur", "Jodhpur Rural", "Karauli",
      "Kekri", "Khairthal-Tijara", "Kota", "Nagaur", "Neem Ka Thana",
...
export const STATE_NAMES = INDIA_LOCATIONS.map((s) => s.state);

export function getDistricts(stateName: string): string[] {
  return INDIA_LOCATIONS.find((s) => s.state === stateName)?.districts ?? [];
}
