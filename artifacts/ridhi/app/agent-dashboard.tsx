...
export default function AgentDashboardScreen() {
  useTrackScreen("agent_dashboard");
  ...
  // ── KYC gate: must be verified before registering as agent ────────────────
  ...
  if (!kycVerified) {
    return (
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }} contentContainerStyle={{ minHeight: "100%" }} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={["#00BCD4", "#7B2FBE"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ paddingTop: topPad + 24, paddingHorizontal: 24, paddingBottom: 28 }}>
          ...
          <View style={{ alignItems: "center", gap: 14 }}>
            ...
            <Text style={{ color: "rgba(255,255,255,0.8)", fontSize: 14, fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 20 }}>
              Complete E-KYC (Aadhaar + PAN) before you can register as an Agent and start earning.
            </Text>
          </View>
        ...
        <View style={{ padding: 24, gap: 14 }}>
          <Pressable onPress={() => router.push("/kyc")}>
            <LinearGradient colors={["#00BCD4", "#7B2FBE"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, paddingVertical: 16, borderRadius: 16 }}>
