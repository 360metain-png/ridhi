...
const PLANS = [
  {
    ...
    features: [
      "Home Feed, Reels & Explore (full scroll)",
      ...
      "Daily missions & coin earning (1 coin each)",
    ],
    locked: [
      "Ad-free experience",
      "VIP badge",
      ...
      "Host audio rooms",
      "Game room & tournament access",
      "AI Matchmaking — smart compatibility scores",
      "AI Smart Icebreakers — auto first messages",
      "AI Reply Suggestions — chat coach",
  ...
  },
  {
    ...
    highlights: ["Ad-free experience", "5 Super Likes/day", "10 audio + 5 video calls/day"],
    features: [
      ...
      "AI Matchmaking — basic scores",
      "AI Smart Icebreakers — English only",
      "AI Reply Suggestions — 1 suggestion per message",
      "Cross-Gender Random Chat — 3 free trial chats/day",
      "TikTok Tools — Auto-Captions only",
      "Creator Dashboard — basic view-only",
  ...
  },
  {
    ...
    popular: true,
    highlights: ["Unlimited HD audio & video calls", "Ghost Mode", "Host audio rooms"],
    features: [
      "Everything in Silver VIP, plus:",
      "Gold VIP badge (animated glow effect)",
      "40 bonus coins/month (≈₹40 value)",
      "UNLIMITED audio calls (no daily cap, HD)",
      "UNLIMITED video calls (no daily cap, HD)",
      "10 Super Likes/day",
      "Ghost Mode — browse matches invisibly",
      "Host audio rooms (up to 20 listeners)",
      "VIP Podcast room access (all rooms)",
      ...
      "AI Reply Suggestions — 3 suggestions per message",
    ...
    locked: [
      ...
      "TikTok Tools (Streaks, Video Replies)",
      ...
      "Custom profile frames",
      "Early access to features",
      "Faster coin withdrawals",
      "Live stream as non-creator (1hr/day)",
    ],
  },
  {
    ...
    highlights: ["100 coins/month bonus", "Host audio rooms (100 listeners)", "Faster withdrawals"],
    features: [
      ...
      "PK Battle spectator (VIP seats)",
      "AI Matchmaking — advanced compatibility + reasons",
      "AI Smart Icebreakers — all 13 languages",
      "AI Reply Suggestions — 5 suggestions per message",
      "AI Conversation Quality Analysis — chat coach",
      "Cross-Gender Random Chat — premium (50 coins/session, E2EE)",
      "End-to-End Encrypted chat — all DMs",
      "Incognito profile visits (invisible browsing)",
      "VIP Game room access (Ludo, Chess, Carrom)",
      ...
      "Go Live — 3 hrs/day (no Creator Pass needed)",
    ...
    locked: [
      "Go Live as a viewer (Diamond feature)",
      "PK Battle hosting (Creator Pass)",
      "Cross-Gender Random Chat (premium)",
      "TikTok full creator suite",
      "Brand Deal Marketplace (direct brands)",
      "Scheduled Content (auto-post)",
  ...
  },
  {
    ...
    highlights: ["300 coins/month bonus", "Go Live (1hr/day)", "Top Explore visibility"],
    features: [
      "Everything in Platinum VIP, plus:",
      "Diamond Elite badge (animated + glow ring)",
      "300 bonus coins/month (≈₹300 value)",
      "Unlimited Super Likes",
      "Go Live as a user (up to 1 hr/day, no Creator Pass needed)",
      "PK Battle participate (spectate + join battles)",
      "VIP Leaderboard position (top 100 visibility)",
      "Top slot in Explore 'People Near You'",
      "Custom profile frame & border effects",
      "Group chat admin (create groups up to 500 members)",
      ...
      "End-to-End Encrypted chat — all DMs",
      "TikTok Tools — full suite (TTS, Carousel, Streaks, Video Replies, Repost, Not Interested)",
      "Creator Dashboard — full analytics",
      "Go Live — unlimited streaming",
      "PK Battle — host & participate",
      ...
      "Custom profile frames & border effects",
...
const UNLOCK_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "AI Chat Coach — full",          plan: "platinum", icon: "cpu"            },
      { label: "AI Matchmaking — full engine",  plan: "diamond",  icon: "heart"          },
      { label: "AI E2EE Chat — all DMs",       plan: "diamond",  icon: "lock"           },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "PK Battle — participate",        plan: "diamond",  icon: "zap"        },
...
const COMPARE_ROWS = [
  ...
  { label: "PK Battle",             free: "✗",       silver: "✗",      gold: "✗",          platinum: "Spectate",diamond: "Host+Join"   },
