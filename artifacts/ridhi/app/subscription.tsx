...
const PLANS = [
  {
    ...
    highlights: ["20 free coins/day", "Basic feed & reels", "3 audio calls/day"],
    features: [
  ...
  },
  {
    ...
    highlights: ["1,000 coins/month bonus", "Host audio rooms (100 listeners)", "Faster withdrawals"],
    features: [
      ...
      "AI assistant — smart chat & caption suggestions",
  ...
  },
  {
    ...
    highlights: ["3,000 coins/month bonus", "Go Live (1hr/day)", "Top Explore visibility"],
    features: [
...
const UNLOCK_CATEGORIES = [
  {
    ...
    items: [
      ...
      { label: "Go Live — 1 hr/day",             plan: "diamond",  icon: "radio"      },
    ],
  },
  {
    title: "Dating & Match",
  ...
  },
  {
    ...
    color: "#34C759",
    items: [
      { label: "AI chat & caption suggestions",  plan: "platinum", icon: "message-circle" },
      { label: "AI assistant (full access)",     plan: "platinum", icon: "cpu"            },
      { label: "Group chat admin (500 members)", plan: "diamond",  icon: "users"          },
      { label: "Referral bonus 2× multiplier",   plan: "diamond",  icon: "gift"           },
      { label: "VIP Leaderboard visibility",     plan: "diamond",  icon: "bar-chart-2"    },
    ],
  },
];
