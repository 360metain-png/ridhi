                ...
                <TableRow key={user.id} className="group hover:bg-muted/30 transition-colors">
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary/80 to-primary/40 flex items-center justify-center text-white font-bold text-sm flex-shrink-0 shadow-sm">
                        {user.name.charAt(0)}
                      </div>
                      <div className="min-w-0">
                        <div className="font-medium text-sm flex items-center gap-1 truncate">
                          {user.name}
                          {user.isVerified && <ShieldCheck className="w-3.5 h-3.5 text-primary flex-shrink-0" />}
                        </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-4 text-xs">
                      ...
                      <span className="flex items-center gap-1" title="Coins">
                        ...
                        <span className="font-medium text-amber-600">{user.coins}</span>
                      </span>
                    </div>
                  </TableCell>
                  <TableCell>
