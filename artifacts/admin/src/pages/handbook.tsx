...
const ADMIN_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    features: [
      "✅ ADMIN CAN ACCESS: Admin Dashboard (operations overview), Host Dashboard, Agent Dashboard, Analytics, Levels & Promotion, E-KYC Verification, Calls, Recordings, AI Hub, Marketing, My Report, Handbook",
      "✅ ADMIN CAN VIEW: Host Dashboard (all host stats, earnings, stream history) and Agent Dashboard (all agent stats, roster, commissions) — read-only for monitoring; edits limited to your assigned scope",
    ...
    note: "Dashboard viewing rule: Admin can see Host Dashboard and Agent Dashboard. Super Admin can see all dashboards — Host, Agent, and Admin. Admin access scope is intentionally limited to protect user privacy and financial integrity.",
  },
  {
    id: "a-dashboard",
    icon: LayoutDashboard,
    ...
    features: [
      ...
      "Dashboard Access Rule: Admin can view Host Dashboard (all host stats, earnings, stream history) and Agent Dashboard (all agent stats, roster, commissions) for monitoring purposes",
      ...
      "Super Admin sees all three dashboards: Admin (operations), Host (host performance), and Agent (agent performance) — full visibility across all roles",
    ],
    note: "Revenue, financial KPIs, and coin purchase stats are visible to Super Admin only — these do not appear on the Admin dashboard view. Dashboard viewing is read-only for Admin; Super Admin has full edit control on all dashboards.",
  },
  {
    id: "a-hosts",
    icon: Star,
