...
const HOST_SECTIONS: Section[] = [
  {
    ...
    features: [
      "Silver VIP (₹49/wk, ₹149/mo, ₹1499/yr): No ads, 20 saved posts, 2 story highlights, 2 Super Likes/day, join events, unlimited polls, 1 pinned post, basic story analytics. Call discount: audio 8 coins/min, video 20 coins/min (20% off). Bonus: 100 coins/month",
      "Gold VIP (₹99/wk, ₹299/mo, ₹2999/yr): Silver + 50 saved posts, 5 highlights, 5 Super Likes/day, 5 profile prompts, broadcast join, group video calls at 100 coins/hr (not a call rate — this is a separate group call feature), advanced story analytics. Call discount: audio 6 coins/min, video 15 coins/min (40% off). Bonus: 350 coins/month",
      "Platinum VIP (₹199/wk, ₹599/mo, ₹5999/yr): Gold + 100 saved posts, 10 highlights, 10 Super Likes/day, 10 prompts, create events, 10% shop discount, cart checkout, AI content assistant unlimited, extra pinned posts at 100 coins. Call discount: audio 5 coins/min, video 12 coins/min (50% off). Bonus: 1000 coins/month",
      "Diamond Elite VIP (₹299/wk, ₹999/mo, ₹9999/yr): Platinum + unlimited saved posts, unlimited highlights, 10 Super Likes/day, unlimited prompts, 15% shop discount, bulk cart checkout, broadcast create, event monetization, collab posts, advanced AI moderation, all analytics included. Call discount: audio 4 coins/min, video 10 coins/min (60% off). Bonus: 3000 coins/month",
  ...
  },
  {
    ...
    color: "text-purple-600",
    bg: "bg-purple-50",
    title: "Your Profile — Tabbed Content",
    subtitle: "Instagram-style 4-tab profile with all your content and stats in one place",
    features: [
      "Posts tab: 3-column grid showing all your photo/video posts. Tap any post to view full-screen. Likes count displayed on hover overlay. Multi-image icon shows posts with multiple photos.",
      "Videos tab: 3-column grid showing all your uploaded videos. Each thumbnail shows a play icon and duration badge. View count displayed below each video.",
      "Reels tab: 3-column grid showing all your short-form reels. Play icon overlay with like count on each thumbnail.",
      "Dashboard tab: 4 stats cards (Followers, Posts, Views, Earnings) with quick at-a-glance numbers. Top Content list ranked by engagement (likes + comments + shares).",
      "Empty state: when a tab has no content, a friendly illustration with 'No content yet' and a CTA to create your first post appears",
      "All profile data is auto-saved to your device and synced with your account",
    ],
  },
  {
    id: "h-avatar-picker",
    ...
    color: "text-pink-600",
    bg: "bg-pink-50",
    title: "Avatar & Photo Quick-Change",
    subtitle: "Tap your profile photo to instantly change your avatar — no menus, no friction",
    steps: [
      { text: "Go to your Profile tab and tap directly on your circular profile photo — the picker opens instantly." },
      { text: "Choose from: Take a photo (camera), Upload from Gallery, Pick a 3D Avatar, or Reset to default." },
      { text: "Select your preferred photo and crop if needed. The avatar updates immediately." },
      { text: "Your new avatar is auto-saved to your account and synced to all other users' feeds." },
    ],
    features: [
      "All 4 avatar change paths (camera, gallery, 3D avatar, reset) auto-save via updateProfile to AsyncStorage for instant persistence",
      "3D avatar grid: 20+ cute avatar options with expressive poses and colors",
      "Reset to default: restores the original purple gradient avatar with your initials",
      "Avatar changes reflect immediately across all screens — Home, Chat, Comments, and others' profiles",
    ],
  },
  {
    id: "h-creator-tools",
    ...
    color: "text-pink-600",
    bg: "bg-pink-50",
    title: "Creator Tools — Tiered Access",
    subtitle: "14 creation tools for every creator, from free to elite",
    features: [
      "Free tools (all users): Upload Studio, Create Post, My Drafts, Basic Analytics, Scheduled Content, Music Library",
      "Starter tools (₹199/mo): Go Live, Podcast Studio — stream and publish episodes",
      "Pro tools (₹499/mo): HD Upload, Boost & Ads, Fan Club — 4K quality, promotion, and paid fan tiers",
      "Elite tools (₹999/mo): Brand Deals, Ridhi Radio, Account Manager — dedicated support and sponsorship marketplace",
      "Access via Profile → Creator Tools — shows tier badge and locked/unlocked state per tool",
      "Locked tools display lock icon with upgrade prompt; tapping opens Creator Pass subscription",
      "Creator Pass is separate from VIP Plans: Starter ₹199/mo, Pro ₹499/mo, Elite ₹999/mo",
      "Commission: 30% (Free) → 20% (Starter) → 13% (Pro) → 8% (Elite) on all creator earnings",
    ],
    note: "Creator Tools are available to every user regardless of host status. No application required. Free tools work immediately; premium tools unlock via Creator Pass subscription.",
  },
  {
    id: "h-creator-dashboard",
    icon: BarChart3,
    color: "text-blue-600",
    bg: "bg-blue-50",
    title: "Creator Dashboard — Tiered Analytics",
    subtitle: "Basic analytics for free; advanced insights for Pro/Elite",
    features: [
      "Basic Analytics (Free): Total Views, New Followers, Profile Visits, Reach — with 7-day and 12-month bar charts",
      "Advanced Analytics (Pro): Watch Time, Avg View Duration, Click-Through Rate, Returning Viewers, Unique Viewers, Impressions, Engagement Rate, Subscriber Conversion",
      "Audience Demographics (Pro): Age distribution, gender split, top cities (Mumbai, Delhi, Bangalore, etc.), device breakdown (Android/iOS/Web)",
      "Revenue Projection (Elite): 6-month forecast chart with actual vs projected earnings, trend indicators",
      "Top Content: Top 3 posts by default; Top 4 with retention rate for Pro/Elite",
      "Earnings Breakdown: Virtual Gifts, Creator Fund, Coin Tips, Download Earnings (Free); plus Live Stream Gifts, Fan Club Subs, Brand Deals (locked until Elite)",
      "KYC banner shows status: Verify to unlock withdrawals / Verified ✓ with green badge",
      "Period toggle: This Week / This Month / All Time — affects chart data range",
      "Locked sections show blurred overlay with upgrade button; tap to subscribe",
    ],
    note: "The Creator Dashboard is available to all users. Free tier shows basic metrics. Pro unlocks demographics and advanced stats. Elite adds revenue forecasting and brand deal earnings.",
  },
  {
    id: "h-polls-quizzes",
    icon: CheckSquare,
    ...
    bg: "bg-violet-50",
    title: "Polls & Quizzes",
    subtitle: "Create interactive polls with up to 4 options. Freemium: 1 free poll/week.",
    features: [
      "Create polls from the Create Post screen — select 'Poll' type and enter up to 4 options",
      "Free users: 1 poll per week. VIP/Creator+ users get unlimited polls.",
      "Extra polls beyond the free limit cost 50 coins each",
      "Polls appear in the feed with real-time vote counts and animated progress bars",
      "Users can vote once per poll. Tapping a poll option triggers haptic feedback",
      "Poll results show percentage breakdown with color-coded bars",
      "Polls expire after 7 days and are automatically archived",
    ],
    note: "Polls drive engagement — use them for Q&A, opinion gathering, or fun community votes.",
  },
  {
    id: "h-story-analytics",
    icon: TrendingUp,
    color: "text-pink-600",
    bg: "bg-pink-50",
    title: "Story Analytics",
    subtitle: "Detailed insights for your stories — views, reactions, demographics",
    features: [
      "View count, reactions breakdown (emoji usage), top cities, peak time, and completion rate",
      "Free users get basic view counts. Advanced analytics cost 200 coins/month or are included with VIP/Creator+.",
      "Tap the analytics icon on any of your own stories to open the analytics overlay",
      "Analytics overlay shows a summary card and detailed breakdown with premium lock for advanced stats",
      "Data updates in real-time as new viewers watch your story",
    ],
  ...
  },
  {
    ...
    bg: "bg-indigo-50",
    title: "Collab Posts",
    subtitle: "Collaborate with another creator on a single post that appears on both profiles",
    features: [
      "Collab posts cost 1000 coins and appear on both collaborators' profiles simultaneously",
      "Partner picker shows followed creators and suggested collaborators during post creation",
      "Both users get equal credit and engagement attribution on the collab post",
      "Collab posts display both creator avatars and names on the post header",
      "Only available for text, photo, and video post types (not reels or stories)",
    ],
    note: "Collab posts are a powerful growth tool — cross-pollinate audiences with creators in your niche.",
  },
  {
    id: "h-pinned-posts",
    icon: MapPin,
    ...
    bg: "bg-amber-50",
    title: "Pinned Posts",
    subtitle: "Pin your best content to the top of your profile",
    features: [
      "1 free pinned post for all users. Extra pinned posts cost 100 coins each (VIP users only).",
      "Pinned posts show a pin icon and appear before all other content on your profile",
      "Pin/Unpin from the post menu (3 dots) on any of your own posts",
      "Pinned posts are highlighted with a colored border in the profile grid",
      "Unpinning a post returns it to its normal position in the chronological feed",
    ],
    note: "Use pinned posts to showcase your best work, announcements, or creator bio links.",
  },
  {
    id: "h-nearby-events",
    icon: Calendar,
    ...
    bg: "bg-emerald-50",
    title: "Nearby Events",
    subtitle: "Discover and host events near you or trending online events",
    features: [
      "Browse events by category: Music, Food, Sports, Tech, Art, Social, Dating",
      "Tabs: Nearby (events in your city), Trending (popular events across India), My Events (events you're hosting or attending)",
      "RSVP to events with one tap. See attendee count and fellow attendees",
      "Host an event for 500 coins. Events can be online or in-person",
  ...
  },
  {
    ...
    subtitle: "AI-powered comment scanning for toxic content across 13 languages",
    features: [
      "AI scans comments for toxic, hateful, or inappropriate content in English + 12 Indian languages",
      "Long-press any comment to access 'AI Moderate' option",
      "Creator+ users get advanced moderation with auto-hide for flagged comments",
      "Basic moderation shows a scan result with no violations detected or a warning if issues are found",
      "Report comments manually if AI misses something — human review follows within 24 hours",
    ],
    note: "AI Moderation helps maintain a safe community. It is a supplement, not a replacement, for human judgment.",
  },
  {
    id: "h-ai-assistant",
    icon: Sparkles,
    ...
    subtitle: "AI-powered caption generation, hashtag suggestions, and content ideas",
    features: [
      "3 free AI uses per day for all users. Extra uses cost 30 coins each.",
      "AI Caption: generate engaging captions based on your post content",
      "AI Hashtags: suggest trending and relevant hashtags for your post",
      "AI Content Ideas: get fresh content ideas tailored to your niche and audience",
      "Daily usage resets at midnight IST. Usage counter shown on the AI chip in Create Post",
    ],
    note: "The AI Assistant is trained on Indian social media trends. Results improve when you provide detailed post descriptions.",
  },
  {
    id: "h-golive",
    icon: Radio,
  ...
  {
    id: "h-emoji-reactions",
    icon: Sparkles,
    color: "text-pink-500",
    bg: "bg-pink-50",
    title: "Emoji Reactions",
    subtitle: "React to posts, reels, voice reels, and live streams with emoji beyond simple likes",
    features: [
      "12 emoji reactions available: ❤️ 🔥 😂 😢 🤯 🙌 👏 😍 😡 😲 💀 🙏",
      "6 default emojis shown on every post: ❤️ 🔥 😂 😢 🤯 🙌",
      "Extended picker: tap + to reveal 6 more emoji: 👏 😍 😡 😲 💀 🙏",
      "Selected emoji highlights in pink (Ridhi brand) with a subtle border glow",
      "Count displayed next to each emoji — K-formatting for 1000+ (e.g., 1.2K)",
      "Tapping a selected emoji removes your reaction (count decrements)",
      "Available on: Posts (Home Feed), Video Reels, Voice Reels, and Live Streams (watch & host views)",
      "Live stream rooms show top reactions on browse cards (e.g., ❤️ 342 🔥 189) so users can see engagement before joining",
      "Emoji reactions are free for all users — no coin cost. They're a lightweight engagement signal beyond likes",
      "Analytics: Super Admin can track emoji reaction counts by content type in the Feature Analytics tab",
    ],
    note: "Emoji reactions are part of the Feed & Content category. They drive higher engagement than simple likes because users can express nuanced emotion (funny, shocking, sad, love).",
  },
  {
    id: "h-whatsapp-status-share",
    icon: Smartphone,
    color: "text-green-600",
    bg: "bg-green-50",
    title: "WhatsApp Status Share",
    subtitle: "One-tap share Ridhi content to WhatsApp Status — just like ShareChat",
    features: [
      "Tap the share icon on any post, reel, story, live stream, or voice reel to open the share sheet",
      "Two WhatsApp options: \"WhatsApp Status\" (share to your status) and \"WhatsApp\" (share to a contact/chat)",
      "WhatsApp Status: opens the native share sheet on mobile — select WhatsApp, then choose \"My Status\"",
      "On web: opens WhatsApp Web with a pre-filled message ready to paste into your status",
      "Share text includes the content title + message + Ridhi link (e.g., https://ridhi.app/reel/r1)",
      "Works for all content types: Posts (text/photo), Video Reels, Voice Reels, Stories, Live Streams",
      "No extra permissions required — uses the built-in system share sheet and deep links",
...
const ADMIN_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    subtitle: "Your role is scoped to operations — you can view Host and Agent dashboards, but all general user data and finance is Super Admin only",
    features: [
      "✅ ADMIN CAN ACCESS: Admin Dashboard (your operations overview), Host Dashboard (your hosts), Agent Dashboard (your agents), Analytics, Levels & Promotion, E-KYC Verification, Calls, Recordings, AI Hub, Marketing, My Report, Handbook",
      "✅ ADMIN CAN VIEW: Your dedicated Host Dashboard (only hosts under your management) and your dedicated Agent Dashboard (only agents under your management) — read-only for monitoring; edits limited to your assigned scope",
    ...
    note: "Dashboard viewing rule: Admin sees only their dedicated Host Dashboard (hosts under their management) and Agent Dashboard (agents under their management). Super Admin sees all dashboards — all Hosts, all Agents, and Admin. Admin access is scoped to their own network to protect user privacy and financial integrity.",
  },
  {
    id: "a-dashboard",
    icon: LayoutDashboard,
    color: "text-blue-600",
    bg: "bg-blue-50",
    title: "Dashboard — Admin, Host & Agent Views",
    subtitle: "Platform overview — KPIs, charts, and live activity. Admin can view Host and Agent dashboards too.",
    features: [
      "Admin Dashboard: your operations overview — Total Users (count only), Daily Active Users, New Registrations Today, KYC Submissions Pending",
      "User growth chart: 7-day and 30-day registration trend (Super Admin only)",
      "Content activity chart: posts, reels, stories published per day (Super Admin only)",
      "Top cities by user activity (Super Admin only)",
      ...
      "Dashboard Access Rule: Admin sees only their dedicated Host Dashboard (hosts under their management) and Agent Dashboard (agents under their management) for monitoring purposes",
      "Host Dashboard shows: host level badge, progress bars (Coins, Stream Hours, PK Wins), Overview/Earnings/Stream History tabs, KYC status, Agent info card, Quick Actions",
      "Agent Dashboard shows: agent level badge, commission rate, Stats row (Active Hosts, Total Hosts, Monthly Volume, Commission Earned), Overview/My Hosts/Levels tabs, Quick Actions",
      "Super Admin sees all dashboards: all Admin (operations), all Hosts (host performance), and all Agents (agent performance) — full visibility across all roles",
    ],
    note: "Revenue, financial KPIs, charts, and platform-wide stats are visible to Super Admin only — these do not appear on the Admin dashboard. Admin sees only their own network data (their hosts, their agents). Dashboard viewing is read-only for Admin; Super Admin has full edit control on all dashboards.",
  },
  {
    id: "a-hosts",
    icon: Star,
...
const SA_SECTIONS: Section[] = [
  {
    ...
    features: [
      ...
      "Dashboard Viewing Rule: SA can see all dashboards — Admin Dashboard (operations), Host Dashboard (host performance), and Agent Dashboard (agent performance). Full visibility across all roles",
    ...
    note: "Dashboard access hierarchy: Admin can view Host Dashboard and Agent Dashboard. Super Admin can view all dashboards — Admin, Host, and Agent. Super Admin credentials must be kept strictly confidential. Never log in from a shared or public device.",
  },
  {
    id: "sa-admin-mgmt",
    icon: UserPlus,
    ...
    features: [
      ...
      "Department-based access: create Departments (e.g. Content, Finance, Creators, Marketing, Support, Tech) with assigned module permissions",
      "Each Department defines which modules its admins can access — assign an admin to a department to auto-apply those permissions",
      "Module-level permissions: 16+ modules across Content, Users, Finance, Operations, Marketing, System categories",
      "Permission presets: Content Moderator, Finance Manager, Creator Manager, Marketing Manager, Support Manager, Tech Manager, and Super Admin",
      "Quick actions: Grant All / Clear All module toggles, individual module switches, progress bar showing permission coverage",
      ...
      "SA decides the scope of each Admin's responsibilities via Departments or custom module assignments",
      "Brief your Admins on which pages they should use daily — their access is scoped automatically by department or custom permissions",
    ],
  },
  {
    id: "sa-users",
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Complete playbook for Hosts, Agents, Admins, and Super Admins — Version 3.5.0
          </p>
        </div>
      ...
      <div className="text-center text-xs text-muted-foreground border-t pt-4">
        <p>Ridhi Platform Handbook · Version 3.5.0 · © 2026 Krilo Digitech Pvt. Ltd.</p>
