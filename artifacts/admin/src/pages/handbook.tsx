...
const ADMIN_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    features: [
      "KPI cards visible to Admin: Total Users (count only), Daily Active Users, New Registrations Today, Host Applications Pending, KYC Submissions Pending",
      ...
      "Quick action links to: Pending Host Applications, Pending KYC, Active Calls, Pending Agent Applications",
  ...
  },
  {
    ...
    features: [
      "Pending Applications tab: all new host registration submissions — review and click Approve or Reject (with rejection reason)",
  ...
  },
  {
    ...
    features: [
      "Pending Applications tab: all new agent registration submissions — approve or reject with a reason",
