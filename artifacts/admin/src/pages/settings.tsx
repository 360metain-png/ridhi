        ...
        <CardContent className="py-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <p className="text-sm font-semibold text-amber-800">Admin Credentials Managed by Backend</p>
              <p className="text-xs text-amber-700">
                Admin and Super Admin credentials are stored securely on the server with bcrypt hashing.
                They cannot be changed from this panel.
                {isSA
                  ? " Contact the backend administrator or use the Super Admin management API to reset credentials."
                  : " Contact your Super Admin if you need credential assistance."}
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                If you are locked out, contact the Super Admin or backend administrator to reset your password.
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <Card>
              ...
              <CardContent>
                ...
                <InputRow label="Tagline"         desc="Short descriptor shown on onboarding and marketing."            value="India's First Social Universal App" />
                <InputRow label="Support Email"   desc="Users see this for complaints and KYC queries."                value="hello@ridhi.app" />
                <InputRow label="Support Phone"   desc="Toll-free or WhatsApp number for host/agent escalations."      value="+91 XXXXX XXXXX" />
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <Card>
              ...
              <CardContent>
                ...
                <ToggleRow label="Brand Deals"            desc="Creator brand deals & sponsorships feature."                                            defaultOn={true}  />
