...
const INITIAL_PRODUCTS: Product[] = [
  ...
  { id: "prod7",  name: "Premium Phone Case",        price: 350,  mrp: 450,  discount: 22, category: "Electronics", image: "https://images.unsplash.com/photo-15595XXXXX-XXXXX8bf5295?w=500",  description: "Durable and slim case for ultimate phone protection.", rating: 4.9, reviews: 78,  active: true, brand: "Spigen", sizes: ["iPhone 15","iPhone 15 Pro","Galaxy S24"], colors: ["Clear","Black","Matte"], stock: 150 },
