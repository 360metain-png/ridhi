...
import {
  ...
  Landmark,
  Gamepad2, Headphones, Music, PenTool, MessageSquare, Camera,
...
const NAV_SECTIONS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Content Editor",   href: "/content-editor",  icon: PenTool,      allowedRoles: SA },
      { name: "Downloads",        href: "/downloads",       icon: Download,     allowedRoles: SA },
      { name: "Screenshots",      href: "/screenshots",     icon: Camera,       allowedRoles: SA },
    ],
  },
  {
    label: "Creators",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Marketplace",         href: "/marketplace",         icon: ShoppingBag,    allowedRoles: SA },
