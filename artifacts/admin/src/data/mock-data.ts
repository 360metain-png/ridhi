...
export const mockCoinRequests: CoinRequest[] = [
  { id: "cr1",  userId: "u1",  userName: "Aarav Sharma",   userPhone: "+91 XXXXX XXXXX", userCity: "Mumbai",    type: "Recharge",   requestedCoins: 1000, amountInr: 399,  reason: REQUEST_REASONS[0], requestedAt: new Date(Date.now() - 600000).toISOString(),      status: "Pending" },
  { id: "cr2",  userId: "u3",  userName: "Vihaan Singh",   userPhone: "+91 XXXXX XXXXX", userCity: "Delhi",     type: "Bonus",      requestedCoins: 200,  reason: REQUEST_REASONS[1], requestedAt: new Date(Date.now() - 1800000).toISOString(),    status: "Pending" },
  { id: "cr3",  userId: "u5",  userName: "Arjun Gupta",    userPhone: "+91 XXXXX XXXXX", userCity: "Bangalore", type: "Refund",     requestedCoins: 500,  amountInr: 199,  reason: REQUEST_REASONS[6], requestedAt: new Date(Date.now() - 3600000).toISOString(),    status: "Pending" },
  { id: "cr4",  userId: "u7",  userName: "Sai Kumar",      userPhone: "+91 XXXXX XXXXX", userCity: "Chennai",   type: "Contest Win",requestedCoins: 5000, reason: REQUEST_REASONS[2], requestedAt: new Date(Date.now() - 7200000).toISOString(),    status: "Pending" },
  { id: "cr5",  userId: "u2",  userName: "Diya Patel",     userPhone: "+91 XXXXX XXXXX", userCity: "Ahmedabad", type: "Complaint",  requestedCoins: 250,  amountInr: 99,   reason: REQUEST_REASONS[9], requestedAt: new Date(Date.now() - 10800000).toISOString(),   status: "Pending" },
  { id: "cr6",  userId: "u9",  userName: "Krishna Iyer",   userPhone: "+91 XXXXX XXXXX", userCity: "Kochi",     type: "Manual Add", requestedCoins: 100,  reason: REQUEST_REASONS[4], requestedAt: new Date(Date.now() - 14400000).toISOString(),   status: "Pending" },
  { id: "cr7",  userId: "u4",  userName: "Aditi Rao",      userPhone: "+91 XXXXX XXXXX", userCity: "Hyderabad", type: "Bonus",      requestedCoins: 500,  reason: REQUEST_REASONS[5], requestedAt: new Date(Date.now() - 86400000).toISOString(),   status: "Approved", reviewedBy: "Super Admin", reviewedAt: new Date(Date.now() - 80000000).toISOString() },
  { id: "cr8",  userId: "u6",  userName: "Ananya Reddy",   userPhone: "+91 XXXXX XXXXX", userCity: "Hyderabad", type: "Recharge",   requestedCoins: 500,  amountInr: 199,  reason: REQUEST_REASONS[0], requestedAt: new Date(Date.now() - 90000000).toISOString(),   status: "Approved", reviewedBy: "Super Admin", reviewedAt: new Date(Date.now() - 85000000).toISOString() },
  { id: "cr9",  userId: "u8",  userName: "Priya Das",      userPhone: "+91 XXXXX XXXXX", userCity: "Kolkata",   type: "Refund",     requestedCoins: 1000, amountInr: 399,  reason: REQUEST_REASONS[6], requestedAt: new Date(Date.now() - 172800000).toISOString(),  status: "Declined", reviewedBy: "Super Admin", reviewedAt: new Date(Date.now() - 170000000).toISOString(), adminNote: "Insufficient proof of double charge" },
  { id: "cr10", userId: "u10", userName: "Riya Desai",     userPhone: "+91 XXXXX XXXXX", userCity: "Pune",      type: "Contest Win",requestedCoins: 2000, reason: REQUEST_REASONS[7], requestedAt: new Date(Date.now() - 259200000).toISOString(),  status: "Approved", reviewedBy: "Super Admin", reviewedAt: new Date(Date.now() - 255000000).toISOString() },
];
...
function coinWithdrawal(id: string, idx: number, role: "User"|"Host"|"Agent", coins: number, method: "UPI"|"Bank", status: "Pending"|"Approved"|"Paid"|"Rejected", daysAgo: number): CoinWithdrawal {
  ...
  return {
    ...
    userPhone: `+91 XXXXX${"XXXXX"}`, userCity: city, kycVerified: true,
